...
import { Menu, X, UserPlus, ClipboardList, Shield, LayoutDashboard } from 'lucide-react';
...
const AdminDashboard = () => {
    ...
    const renderView = () => {
        switch (currentView) {
            ...
            case 'StudentRecords':
                return <div className="p-6"><h1 className="text-2xl font-bold">Student Records</h1></div>;
            case 'TeacherRecords':
                return <div className="p-6"><h1 className="text-2xl font-bold">Teacher Records</h1></div>;
            case 'AddAdmin':
                return <div className="p-6"><h1 className="text-2xl font-bold">Add Admin</h1></div>;
            default:
                return <Dashboard />;
        }
    };
                            ...
                            <li key={index}>
                                <button 
                                    ...
                                    className={`
                                        ...
                                        ${currentView === item.title ? 'ring-2 ring-red ring-opacity-50' : ''}
                                    `}
                                >
                                    {item.icon}
