...
function AddStudent() {
    ...
    const SubmitData = async() => {
       if(FirstName == "" || LastName == ""|| City == "" || FatherName == "" || Gender == "" || DOB == null || FatherCNIC == "" || FatherPhoneNumber == "" || MotherPhoneNumber == "" || Address == "" || !MonthlyFee || RollNumber == ""){
        ...
        <div className="w-full h-full flex items-center justify-center">
            ...
            <div className="w-1/2 h-4/5 bg-darkblue rounded-xl flex flex-col">
                <div className="h-32 w-full flex px-8 justify-between items-center">
                    ...
                    <h1 className="text-2xl text-white font-bold">Student Registration</h1>
                ...
                {FormPage == 0 && (<>
                    ...
                    <input required value={RollNumber} onChange={(e) => { SetRollNumber(e.target.value) }} type="text" className="text-white w-full h-5 bg-transparent border-b border-white focus:outline-none focus:border-blue-500 transition-all duration-300" />
                    ...
                    {FormPage == 1 && (<>
                        ...
                        <input required  type="text" value={FatherName} onChange={(e) => { SetFatherName(e.target.value) }} className="text-white w-full h-5 bg-transparent border-b border-white focus:outline-none focus:border-blue-500 transition-all duration-300" />
                       
                        
                        <label className="text-white font-bold text-lg">
                            Father's CNIC  <span className="text-lg text-orange">*</span>
                        </label>
                        <input required  type="text" value={FatherCNIC} onChange={(e) => { SetFatherCNIC(e.target.value) }} className="text-white w-full h-5 bg-transparent border-b border-white focus:outline-none focus:border-blue-500 transition-all duration-300" />
                        <label className="text-white font-bold text-lg">
                                    Father's Phone no. <span className="text-lg text-orange">*</span>
                                </label>
                                <input type="email" value={FatherPhoneNumber} onChange={(e) => { SetFatherPhoneNumber(e.target.value) }} className="text-white w-full h-5 bg-transparent border-b border-white focus:outline-none focus:border-blue-500 transition-all duration-300" />
                    ...
                    }
                    {
                        FormPage == 2 && (
                            <>
                                ...
                                <label className="text-white font-bold text-lg">
                                    Mother's Phone Number <span className="text-lg text-orange">*</span>
                                </label>
                                <input
                                    type="url"
